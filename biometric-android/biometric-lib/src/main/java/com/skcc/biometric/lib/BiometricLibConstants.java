package com.skcc.biometric.lib;
...
public final class BiometricLibConstants {
    ...
    /**
     * EncryptedSharedPreferences 파일명 — {@link com.skcc.biometric.lib.storage.TokenStorage}
     *
     * <p>TODO: [실서비스] 실MIS앱 패키지명 기반으로 교체
     * <p>주의: 파일명 변경 시 기존 데이터 접근 불가 — 앱 데이터 삭제 후 재등록 필요
     */
    public static final String PREFS_NAME = "com.skcc.biometric.lib.prefs";
     ...
     * com.skcc.biometric.lib.policy.FailurePolicyManager} 가 따름.
     */
